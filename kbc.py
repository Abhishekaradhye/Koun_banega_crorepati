questions = [['What is used to make ice-cream at home ?','Blackpaper powder','Custurd powder','coriender powder','Dry mango powder',2],\
        ...
        ["According to Hinduism, how much years is the durtion of Kaliyuga ?",'1296000 years','864000 years','108000 years','432000 years',4]]
levels = [10000,50000,120000,240000]
print("Get set go ***")
